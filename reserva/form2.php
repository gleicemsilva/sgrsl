...
if(isset($_POST['submit']))
{
    ...
    $query = mysqli_query($conexao, "SELECT * FROM professores WHERE cpf = '$cpf'");
    ...
    if ($rows > 0) {
        ...
        $result = mysqli_query($conexao, "INSERT INTO professores(cpf,nome,email,telefone,senha) VALUES ('$cpf', '$nome', '$email', '$telefone', '$senha')");
